...
public abstract class Hilt_ExamFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ExamFragment_GeneratedInjector) this.generatedComponent()).injectExamFragment(UnsafeCasts.<ExamFragment>unsafeCast(this));
    }
  }
